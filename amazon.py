...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def on_click(self):
        ...
        if check != "":
            ...
            # Set up the Chrome WebDriver using Service and ChromeDriverManager
            ...
            if converted_price < ex_price:
                try:
                    ...
                    x = "* Check your internet Connection\n * Check you enter the right email address"
    ...
    def validator(self):
        ...
        if email_validate.validate(self.usr_email, 0)[0] != QValidator.Acceptable:
            again = again + "Email : Please enter the right email\n"
            self.txtEmail.clear()
        return again
